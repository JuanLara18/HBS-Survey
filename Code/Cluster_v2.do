...
capture log close
log using "${output}/Cluster Results/Program_Clustering_Analysis.log", replace

use "${clean}/V1_qualflags_analysis2.dta", clear
...
graph export "${output}/Cluster Results/Figures/ch_index.png", replace width(1000)
...
graph export "${output}/Cluster Results/Figures/duda_hart_index.png", replace width(1000)
...
graph export "${output}/Cluster Results/Figures/pseudo_t_squared.png", replace width(1000)
...
graph export "${output}/Cluster Results/Figures/elbow_method.png", replace width(1000)
...
graph export "${output}/Cluster Results/Figures/gap_statistic.png", replace width(1000)
...
save "${output}/Cluster Results/optimal_k_values.dta", replace
export delimited "${output}/Cluster Results/optimal_k_values.csv", replace
...
forvalues i = 1/`num_methods' {
    ...
    graph export "${output}/Cluster Results/Figures/distribution_`current_method'.png", replace width(1000)
}
...
save "${output}/Cluster Results/V1_qualflags_analysis2_clustered.dta", replace
...
export delimited "${output}/Cluster Results/optimal_k_values_summary.csv", replace
restore

// 6.3 Export cluster assignments for comparison
preserve
export delimited "${output}/Cluster Results/comparison_assignments.csv", replace
restore