...
capture mkdir "${output}/Cluster Results"
capture mkdir "${output}/Cluster Results/Figures"
capture mkdir "${output}/Cluster Results/Visualizations"
...
forvalues m = 1/3 {
    ...
    graph export "${output}/Cluster Results/Visualizations/participation_`method'.png", replace width(1200)
    ...
    graph export "${output}/Cluster Results/Visualizations/structure_`method'.png", replace width(1200)
    ...
    graph export "${output}/Cluster Results/Visualizations/funding_`method'.png", replace width(1200)
    ...
    graph export "${output}/Cluster Results/Visualizations/target_groups_`method'.png", replace width(1200)
    ...
    graph export "${output}/Cluster Results/Visualizations/target_functions_`method'.png", replace width(1200)
    ...
    graph export "${output}/Cluster Results/Visualizations/characteristics_`method'.png", replace width(1200)
    ...
    if !_rc & _rc == 0 {
        ...
        graph export "${output}/Cluster Results/Visualizations/governance_`method'.png", replace width(1200)
    }
    ...
    graph export "${output}/Cluster Results/Visualizations/challenges_`method'.png", replace width(1200)
    ...
    graph export "${output}/Cluster Results/Visualizations/zscore_profile_`method'.png", replace width(1200)
    ...
    if `k' <= 4 {
        ...
        graph export "${output}/Cluster Results/Visualizations/key_variables_`method'.png", replace width(1200)
    }
    else {
    ...
    preserve
        ...
        // Export table
        export excel using "${output}/Cluster Results/Visualizations/`method'_cluster_summary.xlsx", firstrow(variables) replace
        export delimited using "${output}/Cluster Results/Visualizations/`method'_cluster_summary.csv", replace
    restore
}
...
graph export "${output}/Cluster Results/Visualizations/CH_cluster_by_program.png", replace width(1200)
...
if !_rc {
    ...
    graph export "${output}/Cluster Results/Visualizations/CH_cluster_by_firmsize.png", replace width(1200)
}
...
if !_rc {
    ...
    graph export "${output}/Cluster Results/Visualizations/CH_cluster_by_industry.png", replace width(1200)
}
...
if !_rc {
    ...
    graph export "${output}/Cluster Results/Visualizations/firm_size_by_cluster.png", replace width(1200)
}
...
if "`size_vars'" != "" {
    ...
    graph export "${output}/Cluster Results/Visualizations/firm_size_indicators_by_cluster.png", replace width(1200)
}
...
if "`intl_vars'" != "" {
    ...
    graph export "${output}/Cluster Results/Visualizations/firm_international_by_cluster.png", replace width(1200)
}
...
if "`ind_vars'" != "" {
    ...
    if "`ind_var'" != "" {
        ...
        graph export "${output}/Cluster Results/Visualizations/firm_industry_by_cluster.png", replace width(1200)
    }
}
...
if !_rc {
    ...
    if r(r) <= 6 {
        ...
        graph export "${output}/Cluster Results/Visualizations/union_presence_by_cluster.png", replace width(1200)
    }
}
...
if "`union_vars'" != "" {
    ...
    graph export "${output}/Cluster Results/Visualizations/union_indicators_by_cluster.png", replace width(1200)
}
...
if "`own_vars'" != "" {
    ...
    graph export "${output}/Cluster Results/Visualizations/firm_ownership_indicators_by_cluster.png", replace width(1200)
}
...
if wordcount("`key_firm_vars'") >= 3 {
    ...
    graph export "${output}/Cluster Results/Visualizations/firm_profile_by_cluster.png", replace width(1200)
}
...
preserve
    ...
    *gen count = 1
    ...
    export excel using "${output}/Cluster Results/Visualizations/cluster_size_summary.xlsx", firstrow(variables) replace
    export delimited using "${output}/Cluster Results/Visualizations/cluster_size_summary.csv", replace
restore
...
esttab using "${output}/Cluster Results/Visualizations/cluster_summary_stats.csv", ///
...
if "`firm_sum_vars'" != "" {
    ...
    esttab using "${output}/Cluster Results/Visualizations/firm_summary_stats.csv", ///
        cells("mean(fmt(%9.2f)) sd(fmt(%9.2f))") replace
}
...
preserve
    ...
    export delimited using "${output}/Cluster Results/Visualizations/combined_analysis_data.csv", replace
restore
...
preserve
    ...
    foreach method of local cluster_methods {
        ...
        export delimited using "${output}/Cluster Results/Visualizations/avg_participation_`method'.csv", replace
        ...
        graph export "${output}/Cluster Results/Visualizations/avg_participation_`method'_visual.png", replace width(1200)
...
foreach i of numlist 1/`k' {
    ...
    outreg2 using "${output}/Cluster Results/Visualizations/cluster_regression.xls", replace
    ...
    if !_rc {
        ...
        outreg2 using "${output}/Cluster Results/Visualizations/cluster_regression.xls", append
    }
}
...
preserve
    ...
    // Export results
    export excel using "${output}/Cluster Results/Visualizations/cluster_pvalues.xlsx", firstrow(variables) replace
    export delimited using "${output}/Cluster Results/Visualizations/cluster_pvalues.csv", replace
restore
...
preserve
    ...
    // Save results
    export excel using "${output}/Cluster Results/Visualizations/feature_importance.xlsx", firstrow(variables) replace
    export delimited using "${output}/Cluster Results/Visualizations/feature_importance.csv", replace
restore
...
outreg2 using "${output}/Cluster Results/Visualizations/cluster_regression_updated.xls", replace ctitle("Base")
...
foreach hr_var in p_targetemp_c p_targetemp_mm p_targetfunc_hr {
    ...
    if !_rc {
        ...
        outreg2 using "${output}/Cluster Results/Visualizations/cluster_regression_updated.xls", append ctitle("`hr_var'")
    }
}
...
preserve
    ...
    // Save empty dataset
    save "${output}/Cluster Results/Visualizations/firm_cluster_analysis.dta", replace
restore
...
foreach var of local firm_vars {
    ...
    if !_rc {
        ...
        // Save results
        preserve
            use "${output}/Cluster Results/Visualizations/firm_cluster_analysis.dta", clear
            set obs `row'
...
preserve
    ...
    export excel using "${output}/Cluster Results/Visualizations/firm_cluster_analysis.xlsx", firstrow(variables) replace
    export delimited using "${output}/Cluster Results/Visualizations/firm_cluster_analysis.csv", replace
restore
...
preserve
    tabout cluster_ch program using "${output}/Cluster Results/Visualizations/cluster_program_distribution.csv", replace cells(row col) format(1p) style(csv)
restore
